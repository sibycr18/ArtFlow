...
import { Type, ArrowLeft, Bold, Italic, Underline, AlignLeft, AlignCenter, AlignRight, AlignJustify, Download, ChevronLeft, ChevronRight } from 'lucide-react';
      ...
      <div className="bg-white border-b border-purple-100 p-4">
        <div className="flex items-center justify-between max-w-screen-2xl mx-auto">
          ...
          <div className="text-sm text-gray-600">
            <span className={`inline-block w-2 h-2 rounded-full mr-2 ${isConnected ? 'bg-green-500' : connectionError ? 'bg-red-500' : 'bg-yellow-500'}`}></span>
            {connectionStatus}
          </div>
        </div>
      </div>

      {/* Main Content - UI structure remains the same */}
